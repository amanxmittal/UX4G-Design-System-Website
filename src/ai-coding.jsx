...
function AiCoding() {
  return (
    <AiShell
      ...
      desc="The DESIGN.md plus per-tool rules-file pattern that works across Claude Code, Cursor, Copilot and Codex. Plus prompting techniques, translated out of ML jargon, that your team can actually use."
      sections={SECTIONS}
    >
      {/* 1 */}
      <section id="channels" className="cd-section">
        <div className="cd-section-num">01 · Channels</div>
        <h2 className="cd-section-title">Five channels for UX4G design system context. Use them in combination.</h2>
        ...
        <div className="num-grid">
          {[
            { n: "a", name: "Project-level instructions", text: "A single DESIGN.md at the repo root plus a per-tool rules file. The highest-leverage move you can make." },
            { n: "b", name: "A well-structured DESIGN.md", text: "Product brief, principles, tokens with intent, type logic, components, and the most-skipped section: Don'ts." },
            { n: "c", name: "The UX4G npm package", text: "Install and import from the UX4G design system package. Code Connect maps every Figma component to its npm implementation." },
            { n: "d", name: "The Figma MCP server", text: "Exposes UX4G variables, components and Code Connect mappings to any MCP-aware agent. Pairs the Figma file to the code mirror." },
            { n: "e", name: "Storybook MCP", text: "@storybook/addon-mcp on the UX4G Storybook exposes a Component Manifest agents can query, plus a11y and interaction tests they can run." },
          ].map((c) => (
      ...
      <section id="tree" className="cd-section">
        ...
        <h2 className="cd-section-title">Where rules files live in a project repo</h2>
        <p className="cd-section-lede">
...
└── `}<span className="ft-dir">src/</span>
      ...
      <section id="tools" className="cd-section">
        ...
        <h2 className="cd-section-title">Rules files in different tools</h2>
        <p className="cd-section-lede">
