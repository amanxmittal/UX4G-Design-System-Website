...
function AiFigma() {
  return (
    <AiShell
      ...
      crumb="In Figma"
      title="AI in Figma"
      desc="Three Figma AI products, all of which can work with the UX4G design system today. The Design Agent for canvas-native iteration, Figma Make for prompt-to-app via the UX4G Make kit, and the MCP server for code handoff."
      sections={SECTIONS}
    >
      {/* 1 */}
      <section id="products" className="cd-section">
        <div className="cd-section-num">01 · Landscape</div>
        <h2 className="cd-section-title">Figma's AI products: Design agent, Make & MCP server.</h2>
        ...
        <p className="ai-prose" style={{ marginTop: 20, fontStyle: "italic", color: "var(--gray-700)" }}>
          The Design Agent is in rolling beta as of May 2026. Available to Full seat users on Professional, Organisation and Enterprise
          plans.
        </p>
      </section>
