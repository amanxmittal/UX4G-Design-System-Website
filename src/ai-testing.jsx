...
function AiTesting() {
  return (
    <AiShell
      code="AI-06"
      crumb="Testing & evaluation"
      title="Testing & evaluation"
      desc="The full ten-layer ladder, the three-pass AI-aided review prompt, ready-to-run CI snippets, the benchmarks that should flip your AI plan, and the real-world failures that prove every gate."
      sections={SECTIONS}
    >
      {/* 1 · Ladder */}
      ...
      <section id="review" className="cd-section">
        ...
        <div className="num-grid">
          {[
            { n: "01", name: "List every problem", text: "Ask only for findings, with file:line. No fixes. The model is loose with this if not constrained. Insist." },
            { n: "02", name: "Propose fixes for each", text: "Take the enumerated list back and ask for one fix per finding. Each fix shows a diff and a justification." },
            { n: "03", name: "A human decides", text: "Take the proposed fixes into a human review. Accept, reject, modify. AI-assisted, not AI-automated." },
          ].map((c) => (
