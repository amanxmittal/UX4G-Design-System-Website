            ...
            <header className="cd-header">
              <div className="cd-title-block">
                <div className="cd-crumb">
                  ...
                  <span className="sep">/</span>
                  <span className="current">Figma Make</span>
                </div>
                <div className="cd-title-row">
                  <h1 className="cd-title">Figma Make</h1>
                  <span className="cd-chip">AI-05 · Deep dive</span>
                </div>
              </div>
              <div className="cd-meta-block">
                Figma's prompt-to-app product, in detail. What its model is, the three context inputs,
                and how to register the UX4G npm package as a Make kit so every prompt generates
                component-accurate code from the first turn.
                <div className="cd-meta-row">
                  <span>Audience · design system leads, developers</span>
            ...
            <section id="what" className="cd-section">
              ...
              <div className="make-sketch">
                ...
                <div className="ms-preview">
                  ...
                  <div style={{ fontFamily: "var(--font-display)", fontWeight: 600, fontSize: 22, letterSpacing: "-0.018em", color: "var(--ink)" }}>
            ...
            <section id="share" className="cd-section">
              ...
              <div className="num-grid cols-2">
                <div className="num-cell">
                  <span className="n-num">SHARE · 01</span>
                ...
                <div className="num-cell">
                  <span className="n-num">SHARE · 02</span>
                ...
                <div className="num-cell">
                  <span className="n-num">SHARE · 03</span>
                ...
                <div className="num-cell" style={{ background: "var(--amber-soft)" }}>
                  <span className="n-num">SHARE · 04</span>
              ...
              <div className="row-2 ai-prose">
                ...
                <div>
                  ...
                  <div style={{ marginTop: 14, padding: "18px 20px", border: "1px solid var(--gray-200)", borderRadius: 10, background: "#fff" }}>
                    <h4 style={{ fontFamily: "var(--font-display)", fontWeight: 600, fontSize: 15, letterSpacing: "-0.01em", margin: "0 0 8px" }}>The single highest-impact NeGD action</h4>
