...
- Add `DESIGN.md` and `AGENTS.md` to every UX4G design system-adopting repository (template available from NeGD). Reference the UX4G design system npm package in both files.
