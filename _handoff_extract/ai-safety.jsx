          ...
          <div className="cd-main">
            ...
            <header className="cd-header">
              <div className="cd-title-block">
                <div className="cd-crumb">
                  ...
                  <span className="sep">/</span>
                  <span className="current">Governance & safety</span>
                </div>
                <div className="cd-title-row">
                  <h1 className="cd-title">Governance & safety</h1>
                  <span className="cd-chip">AI-03 · For governance</span>
                </div>
              </div>
              <div className="cd-meta-block">
                The hard never-list, the vendor checklist, the testing ladder, and why vibe coding is
                fine for prototypes and dangerous for citizen-facing production. Aligned with the DPDP
                Act, 2023 and the Finance Ministry's January 2025 advisory.
                <div className="cd-meta-row">
                  <span>Audience · CISO, legal, DPO, tech leads</span>
            ...
            <section id="law" className="cd-section">
              ...
              <div style={{ marginTop: 28, background: "#fff", border: "1px solid var(--gray-200)", borderRadius: 12, padding: "20px 24px" }}>
                <h4 style={{ fontFamily: "var(--font-display)", fontWeight: 600, fontSize: 16, letterSpacing: "-0.012em", margin: "0 0 14px" }}>SDF obligations once designated</h4>
