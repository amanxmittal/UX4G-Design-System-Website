        ...
        <div className="cd-layout">
          <div className="cd-main">
            ...
            <header className="cd-header">
              <div className="cd-title-block">
                <div className="cd-crumb">
                  ...
                  <span className="sep">/</span>
                  <span className="current">Prompting</span>
                </div>
                <div className="cd-title-row">
                  <h1 className="cd-title">Prompting</h1>
                  <span className="cd-chip">AI-04 · Deep dive</span>
                </div>
              </div>
              <div className="cd-meta-block">
                A library of vetted UX4G prompts your team can copy, plus the five techniques that lift
                quality the most, with one bad example and one good example each.
                <div className="cd-meta-row">
                  <span>Audience · designers, developers, reviewers</span>
            ...
            <section id="anatomy" className="cd-section">
              ...
              <h2 className="cd-section-title">Anatomy of a UX4G prompt</h2>
              <p className="cd-section-lede">
                Six parts, in this order. Each part removes a degree of freedom the model would
                otherwise take. Treat the order as a checklist, not a script.
              </p>
              <div className="row-2 ai-prose">
                <div>
                  <div className="num-grid cols-2" style={{ gridTemplateColumns: "repeat(2, 1fr)" }}>
                    {[
                      { n: "01", name: "Context", text: "What we're building and for whom. 2G citizen networks, multilingual readers, 2nd-language English." },
                      { n: "02", name: "Role", text: "Who the model is. 'A senior front-end developer using UX4G v3.0.'" },
                      { n: "03", name: "Instructions", text: "The task itself. Specific, imperative, one verb." },
                      { n: "04", name: "Specifics", text: "Sample inputs, screenshots, links to UX4G docs and DESIGN.md." },
                      { n: "05", name: "Constraints", text: "WCAG 2.1 AA. Noto Sans. Import from the UX4G npm package only. Bilingual." },
                      { n: "06", name: "Example output", text: "Paste one good component as a few-shot. The model imitates structure faithfully." },
                    ].map((p) => (
                ...
                <div>
                  <div className="code-window">
                    <div className="cw-bar">
                      ...
                      <span className="title">prompt.md · all six parts</span>
                    </div>
<pre>
<span className="c"># Context</span>
A Janma Pramaan Patra application form
for a state portal serving citizens
on 2G-4G mobiles, in Hindi and English.

<span className="c"># Role</span>
You are a senior front-end developer
using UX4G v3.0.

<span className="c"># Instructions</span>
Build a 3-step form using UX4G
Stepper, Input, Button components.

<span className="c"># Specifics</span>
Step 1: applicant details (name,
DOB, mobile, Aadhaar).
Step 2: address.
Step 3: review + consent.

<span className="c"># Constraints</span>
- WCAG 2.1 AA. Noto Sans only.
- Import from the UX4G npm package.
- DPDP 2023 consent surface on step 3.

<span className="c"># Example output</span>
[paste one good UX4G form here]
</pre>
                  </div>
                </div>
              </div>
            ...
            <section id="techniques" className="cd-section">
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 28 }}>
                ...
                <div>
                  <h3 style={{ fontFamily: "var(--font-display)", fontWeight: 600, fontSize: 18, margin: "0 0 6px", letterSpacing: "-0.012em" }}>
...
Wait for me to approve before generating any code.</div>
            ...
            <section id="library" className="cd-section">
              ...
              <h2 className="cd-section-title">Five vetted UX4G prompts your team can copy</h2>
              <p className="cd-section-lede">
...
For each finding: severity (A / AA / AAA), file:line, fix outline.`}
            ...
            <section id="checkpoints" className="cd-section">
              ...
              <p className="cd-section-lede">
                The single biggest cause of hallucinated UX4G code is models generating before they
              ...
              <div className="num-grid cols-2">
                {[
                  ...
                  <div className="num-cell" key={c.n}>
                    <span className="n-num">ANTI · {c.n}</span>
          ...
          <Sidebar sections={SECTIONS} active={active}
            extras={[
              ...
              { label: "AI-06 · Testing", href: "UX4G AI Testing.html" },
            ]}
          />
        </div>
      </main>
